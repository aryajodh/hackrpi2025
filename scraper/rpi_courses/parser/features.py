...
def semester_feature(catalog, soup):
    ...
    # Note: This logic works identically in Python 2 and 3.
...
def crosslisting_feature(catalog, soup):
    ...
    for elem in soup.coursedb.findAll('crosslisting'):
        ...
        # CRITICAL CHANGE: Ensure safe iteration over BeautifulSoup results in Py3
        # findAll returns an iterable, and list comprehension works fine in Py3.
        # safeInt is used correctly here.
    ...
    # The length argument for the log is fine as is
...
def course_feature(catalog, soup):
    ...
    # Python 3 code is implicitly fine here.
    catalog.courses = courses
    
    # catalog.courses is redundant and removed
